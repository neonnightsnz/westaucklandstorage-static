// Current marketing pages. Original articles live in blogPosts.json.
export const pages = [
  {
    "slug": "about",
    ...
    "sections": [
      ...
      {
        "heading": "The promise is simple",
        "paragraphs": [
          "Your boat, caravan or gear is in safe hands, close to home, without the marina price tag. That means clear answers, flexible arrangements and a team that will help you find your spot."
        ]
      }
    ],
    "bullets": [
